...
ENV PANDRUGS_BACKEND_URL http://static.sing-group.org/pandrugs/pandrugs-backend-1.1.7.war
ENV PANDRUGS_FRONTEND_URL http://static.sing-group.org/pandrugs/pandrugs-frontend-1.2.3.tar.gz
