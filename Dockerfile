FROM ubuntu:16.04
LABEL org.opencontainers.image.authors="dgpena@uvigo.gal"
...
ENV APP_BACKEND_VERSION 2024.05
ENV APP_FRONTEND_VERSION 2024.05
ENV APP_DB_SCHEMA_VERSION 2024.05
ENV APP_DB_DATA_VERSION 2024.05
